...
class DateUtil {
    ...
    public static Date getDate(String datestring) {
        ...
        if (format == null) {
            ...
            return tryToGetDateWithNamedMonth(datestring);
        }
        try {
    ...
    /**
     * Some of our date strings are like this 17-Feb-2009
     * @param datestring
     * @return
     */
    private static Date tryToGetDateWithNamedMonth(String datestring) {
        ...
        try {
           ...
           logger.error("Could not parse datestring=\""+datestring+"\"");
            System.exit(1);
