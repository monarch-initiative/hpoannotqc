...
public class Genes2PhenotypesCommand implements Command  {
    ...
    @Parameter(names={"--annot-file"}, description = "path to phenotype.hpoa file (as generated by this program)",
    required = true)
    ...
    public void execute() {
       ...
       if (annotLisrt == null) {
           System.err.println("[FATAL] could not retrieved HPO gene annotation list");
           System.exit(1);
       }
       try {
